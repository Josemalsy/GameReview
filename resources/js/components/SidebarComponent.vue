...
export default {
  ...
  methods: {
    ...
    getDatosMensajes(){
      ...
      axios.get('http://gamereviewsproject.herokuapp.com:8000/api/consultar_avisos_mensajes', {
        params: {
    ...
    getDatosReviews(){
      axios.get('http://gamereviewsproject.herokuapp.com:8000/api/consultar_avisos_reviews', {
        params: {
    ...
    getUnban(){
      axios.get('http://gamereviewsproject.herokuapp.com:8000/api/getUnban', {
        params: {
          user_id: this.current_user.id
        }
      })
