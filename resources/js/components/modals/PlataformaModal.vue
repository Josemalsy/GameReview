  ...
  methods: {
    ...
    addPlataforma(){
      ...
      if(this.tituloModal == 'Actualizar plataforma'){
        ...
        axios.post('http://gamereviewsproject.herokuapp.com:8000/api/update_plataforma',this.form)
          .then(response => {
        ...
        axios.post('http://gamereviewsproject.herokuapp.com:8000/api/create_plataforma',this.form).then(response => {
    ...
    obtenerDatos(){
      axios.get('http://gamereviewsproject.herokuapp.com:8000/api/getAllPlataformasById',{
        params: {
