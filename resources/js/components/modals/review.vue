...
import  VueEditor from "vue2-editor";
  ...
  export default {
    ...
    methods: {
      ...
      plataformaActual(){
        axios.get('http://gamereviewsproject.herokuapp.com/api/getPlataformaGameUser',{
          params: {
            game_id: this.$route.params.id,
            user_id: this.current_user.id
          }
      ...
      traeReview(){
        axios.get('http://gamereviewsproject.herokuapp.com/api/get_reviews_By_User_Game',{
          params: {
      ...
      createReview(){
        if(this.tituloModal == 'Enviar Reseña'){
          axios.post('http://gamereviewsproject.herokuapp.com/api/review/post_review',this.form)
          .then(response => {
          ...
          axios.post('http://gamereviewsproject.herokuapp.com/api/review/edit_review',this.form)
          .then(response => {
