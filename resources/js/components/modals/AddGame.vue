...
export default {
  ...
  methods: {
    ...
    getPlataformaData(){
      axios.get('http://gamereviewsproject.herokuapp.com/api/getPlataformas')
        .then(response => {
        this.listaPlataformas = response.data;
      })
    },
    getGeneroData(){
      axios.get('http://gamereviewsproject.herokuapp.com/api/getGeneros')
        .then(response => {
        this.listaGeneros = response.data;
      })
    },
    obtenerDatos() {
      axios.get('http://gamereviewsproject.herokuapp.com/api/juego/' + this.game_id).then(response =>{
    ...
    addGame(){
      ...
      if(this.tituloModal == 'Actualizar Juego'){
        ...
        axios.post('http://gamereviewsproject.herokuapp.com/api/juego/updateGame', formData)
        .then(response => {
        ...
        axios.post('http://gamereviewsproject.herokuapp.com/api/juego/add_game', formData)
        .then(response => {
