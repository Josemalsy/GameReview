...
export default {
  ...
  methods: {
    ...
    getDatosUsuarios(){
      axios.get('https://gamereviewsproject.herokuapp.com/api/getAllUsers').then(response => {
    ...
    enviarMensaje(){
      ...
      if(this.checkDestino == true && this.checkMensaje == true && this.checkLongitudTitulo == true && this.current_user != false){
        ...
        if(this.tituloModal == "Enviar Mensaje" || this.tituloModal == "Mandar mensaje"){
          ...
          axios.post('https://gamereviewsproject.herokuapp.com/api/enviar_mensaje',this.form)
          .then(response => {
          ...
          this.form.receptor_id = this.receptor_id
          this.form.conversacion_id = this.conversacion_id
          axios.post('https://gamereviewsproject.herokuapp.com/api/responder_mensaje', this.form).then(response => {
            this.$refs["modal"].hide()
            this.$bus.$emit('prueba')
