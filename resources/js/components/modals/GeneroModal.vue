  ...
  methods: {
    ...
    addGenero(){
      ...
      if(this.tituloModal == 'Actualizar género'){
        ...
        axios.post('http://gamereviewsproject.herokuapp.com:8000/api/update_genero',this.form)
          .then(response => {
        ...
        axios.post('http://gamereviewsproject.herokuapp.com:8000/api/create_genero',this.form).then(response => {
    ...
    obtenerDatos(){
      axios.get('http://gamereviewsproject.herokuapp.com:8000/api/getGenerosById',{
        params:{
