...
export default {
  ...
  methods: {
    getDatosMensaje(){
      ...
      axios.get('https://gamereviewsproject.herokuapp.com:8000/api/getMensajeById', {
        params: {
    ...
    getDatosConversacion(){
      ...
      axios.get('https://gamereviewsproject.herokuapp.com:8000/api/getConversacionesById', {
        params: {
