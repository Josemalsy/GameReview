...
export default {
  ...
  methods: {
    getMensajesRecibidos(){
      ...
      axios.get('https://gamereviewsproject.herokuapp.com:8000/api/mensajes_recibidos', {
          params: {
    ...
    getMensajesEnviadosLeidos(){
			this.vacio = false
      this.mensajesSeleccionados = [],
      axios.get('https://gamereviewsproject.herokuapp.com:8000/api/mensajes_enviados_leidos',{
        params: {
          user_id: this.current_user.id,
        }
      })
    ...
    getMensajesEnviadosNoLeidos(){
      ...
      this.mensajesSeleccionados = [],
      axios.get('https://gamereviewsproject.herokuapp.com:8000/api/mensajes_enviados_no_leidos', {
        params: {
          user_id: this.current_user.id,
        }
      })
    ...
    borrarMensajes(){
      ...
      Swal.fire({
        ...
        if(result.isConfirmed){
          axios.get('https://gamereviewsproject.herokuapp.com:8000/api/borrar_mensajes',{
            params: {
