  ...
  methods: {
    ...
    getStatsGamePlataformas(){
      ...
      if(this.cargarGamePlataformas == false) {
        ...
        axios.get('http://localhost:8000/api/getCountJuegosPorPlataforma/').then(response =>{
          let arraySize = response.data.length
          for(let x = 0; x < arraySize; x++){
    ...
    getStatsGameFabricante(){
      ...
      if(this.cargarGameFabricante == false) {
        ...
        axios.get('http://localhost:8000/api/getCountJuegosPorFabricante/').then(response =>{
          let arraySize = response.data.length
          for(let x = 0; x < arraySize; x++){
    ...
    getStatsGameGenero(){
      ...
      if(this.cargarGameGenero == false) {
        ...
        axios.get('http://localhost:8000/api/getCountJuegosPorGenero/').then(response =>{
          let arraySize = response.data.length
          for(let x = 0; x < arraySize; x++){
