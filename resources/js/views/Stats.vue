  ...
  methods: {
    getStatsSexUsers(){
      ...
      if(this.cargarSexoUsers == false){
        ...
        axios.get('https://gamereviewsproject.herokuapp.com/api/stats_sexo_usuarios/').then(response =>{
    ...
    getStatsGamePlataformas(){
      ...
      if(this.cargarGamePlataformas == false) {
        ...
        axios.get('https://gamereviewsproject.herokuapp.com/api/getCountJuegosPorPlataforma/').then(response =>{
          let arraySize = response.data.length
          for(let x = 0; x < arraySize; x++){
    ...
    getStatsGameFabricante(){
      ...
      if(this.cargarGameFabricante == false) {
        ...
        axios.get('https://gamereviewsproject.herokuapp.com/api/getCountJuegosPorFabricante/').then(response =>{
          let arraySize = response.data.length
          for(let x = 0; x < arraySize; x++){
    ...
    getStatsGameGenero(){
      ...
      if(this.cargarGameGenero == false) {
        ...
        axios.get('https://gamereviewsproject.herokuapp.com/api/getCountJuegosPorGenero/').then(response =>{
          let arraySize = response.data.length
          for(let x = 0; x < arraySize; x++){
