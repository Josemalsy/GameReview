...
props : ['current_user'],
  ...
  methods: {
    getGeneros(){
      axios.get('http://gamereviewsproject.herokuapp.com:8000/api/getGeneros/').then(response =>{
    ...
    borrarGenero(value){
        Swal.fire({
          ...
          if(result.isConfirmed){
            axios.delete('http://gamereviewsproject.herokuapp.com:8000/api/delete_genero', {
              params: {
                genero_id: value
              }
            }).then(response =>{
