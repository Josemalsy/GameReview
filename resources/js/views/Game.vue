...
export default {
  ...
  props : ['current_user'],
	...
	methods: {
		obtenerDatos() {
				this.loading =  true,
				axios.get('https://gamereviewsproject.herokuapp.com/api/juego/' + this.id_game,{
					params: {
		...
		ObtenerDatosReview(){
			...
			axios.get('https://gamereviewsproject.herokuapp.com/api/review/' + this.id_game + '/?page='+ this.page, {
				params: {
					id:this.id_game
				}
			}).then(response =>{
		...
		getDatosPuntuaciones(){
			...
			this.loadingPuntuaciones = true
				axios.get('https://gamereviewsproject.herokuapp.com/api/get_puntuacionesById/', {
					params: {
		...
		getDatosPlataformas(){
			...
			this.loadingPlataformas = true
				axios.get('https://gamereviewsproject.herokuapp.com/api/stats_Plataformas_Games/', {
					params: {
						game_id: this.id_game
					}
				}).then(response =>{
