...
props : ['current_user'],
  ...
  methods: {
    getPlataformas(){
      axios.get('https://gamereviewsproject.herokuapp.com:8000/api/getPlataformas/').then(response =>{
    ...
    borrarPlataforma(value){
        Swal.fire({
          ...
          if(result.isConfirmed){
            axios.delete('https://gamereviewsproject.herokuapp.com:8000/api/delete_plataforma', {
              params: {
                plataforma_id: value
              }
            }).then(response =>{
